/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2018/12/17 15:03:19                          */
/*==============================================================*/


alter table Book_lend_record 
   drop foreign key FK_BOOK_LEN_REFERENCE_USERPEOP_2;

alter table Book_lend_record 
   drop foreign key FK_BOOK_LEN_RELATIONS_BOOK;

alter table Book_lend_record 
   drop foreign key FK_BOOK_LEN_RELATIONS_USERPEOP_1;

alter table Drug 
   drop foreign key FK_DRUG_MANUFACTO_MANUFACT;

alter table Drug 
   drop foreign key FK_DRUG_RETAILER_RETAILER;

alter table Drug_procurement_form 
   drop foreign key FK_DRUG_PRO_REFERENCE_USERPEOP_1;

alter table Drug_procurement_form 
   drop foreign key FK_DRUG_PRO_REFERENCE_USERPEOP_3;

alter table Drug_procurement_form 
   drop foreign key FK_DRUG_PRO_RELATIONS_USERPEOP_2;

alter table Drug_procurement_form 
   drop foreign key FK_DRUG_PRO_RELATIONS_DRUG;

alter table Drug_request_form 
   drop foreign key FK_DRUG_REQ_REFERENCE_USERPEOP_3;

alter table Drug_request_form 
   drop foreign key FK_DRUG_REQ_REFERENCE_USERPEOP_1;

alter table Drug_request_form 
   drop foreign key FK_DRUG_REQ_RELATIONS_USERPEOP_2;

alter table Drug_request_form 
   drop foreign key FK_DRUG_REQ_RELATIONS_DRUG;

alter table Primer 
   drop foreign key FK_PRIMER_REFERENCE_USERPEOP_1;

alter table Primer 
   drop foreign key FK_PRIMER_REFERENCE_USERPEOP_2;
...
alter table Vacation_record 
   drop foreign key FK_VACATION_REFERENCE_USERPEOP_2;

alter table Vacation_record 
   drop foreign key FK_VACATION_RELATIONS_USERPEOP_1;
...
drop index Index_4 on Book_lend_record;
...
/* Index: Index_4                                               */
/*==============================================================*/
create index Index_4 on Book_lend_record
(
   approval_people_id
);
...
alter table Book_lend_record add constraint FK_BOOK_LEN_REFERENCE_USERPEOP_2 foreign key (approval_people_id)
...
alter table Book_lend_record add constraint FK_BOOK_LEN_RELATIONS_USERPEOP_1 foreign key (UserPeople_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;
...
alter table Drug add constraint FK_DRUG_RETAILER_RETAILER foreign key (Retailer_id)
      references Retailer (Retailer_id) on delete restrict on update restrict;

alter table Drug_procurement_form add constraint FK_DRUG_PRO_REFERENCE_USERPEOP_1 foreign key (scrutiny_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;

alter table Drug_procurement_form add constraint FK_DRUG_PRO_REFERENCE_USERPEOP_3 foreign key (user_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;

alter table Drug_procurement_form add constraint FK_DRUG_PRO_RELATIONS_USERPEOP_2 foreign key (request_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;
...
alter table Drug_request_form add constraint FK_DRUG_REQ_REFERENCE_USERPEOP_3 foreign key (scrutiny_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;

alter table Drug_request_form add constraint FK_DRUG_REQ_REFERENCE_USERPEOP_1 foreign key (user_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;

alter table Drug_request_form add constraint FK_DRUG_REQ_RELATIONS_USERPEOP_2 foreign key (request_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;

alter table Drug_request_form add constraint FK_DRUG_REQ_RELATIONS_DRUG foreign key (Drug_id)
      references Drug (Drug_id) on delete restrict on update restrict;

alter table Primer add constraint FK_PRIMER_REFERENCE_USERPEOP_1 foreign key (request_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;

alter table Primer add constraint FK_PRIMER_REFERENCE_USERPEOP_2 foreign key (approval_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;
...
alter table Vacation_record add constraint FK_VACATION_REFERENCE_USERPEOP_2 foreign key (approval_people_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;

alter table Vacation_record add constraint FK_VACATION_RELATIONS_USERPEOP_1 foreign key (UserPeople_id)
      references UserPeople (UserPeople_id) on delete restrict on update restrict;
